...
from .models import Paciente, Medico, Funcionario, ExameAgendado, ConsultaAgendada, ExameClinica, EspecialidadeClinica, Convenio
from .forms import PacienteForm, MedicoForm, FuncionarioForm, ExameAgendadoForm, ConsultaAgendadaForm, ExameClinicaForm, EspecialidadeClinicaForm, ConvenioForm
...
def funcionarios_cadastrados(request):
    ...
    return render(request, 'recepcionistas/funcionarios_cadastrados.html', {'funcionarios': funcionarios})
...
def cadastrar_funcionario(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return redirect('funcionarios_cadastrados')
    else:
        form = FuncionarioForm()
    return render(request, 'recepcionistas/cadastrar_funcionario.html', {'form': form})
