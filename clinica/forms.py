...
from .models import Paciente, Medico, ExameClinica, EspecialidadeClinica, ExameAgendado, ConsultaAgendada

from django import forms
from .models import Paciente, Medico, ExameClinica, EspecialidadeClinica, ExameAgendado, ConsultaAgendada, Convenio
